export type ThemeStringType = "classic" | "deuteranope"  | "protanope"  | "tritanope" | "flat" | "high-contrast" | "lines" | "modern" | "shapes"
...
export abstract class AbstractTheme {
    ...
    setStonesColorTo(theme : string) {
        document.documentElement.style.setProperty("--black-stone-img",`var(--black-stone-img-${theme})`)
        document.documentElement.style.setProperty("--blue-stone-img",`var(--blue-stone-img-${theme})`)
        document.documentElement.style.setProperty("--red-stone-img",`var(--red-stone-img-${theme})`)
        document.documentElement.style.setProperty("--green-stone-img",`var(--green-stone-img-${theme})`)        
    }

    setCellBackgroundColor(color :string) {
        document.documentElement.style.setProperty("--cell-background-color",color) 
    }

    setHeaderColors(headerBackground :string, headerOutline : string) {
        document.documentElement.style.setProperty("--header-background-color",headerBackground)
        document.documentElement.style.setProperty("--header-outline-color",headerOutline)
    }
